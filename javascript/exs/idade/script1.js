function verificar() {
    ...
    if (fano.value.length == 0 || fano.value > ano){
        ...
        if (fsex[0].checked){
            ...
            if (idade >=0 && idade < 10) {
                // Criança
                img.setAttribute('src', 'components/imagens/bbf.png')
            } else if (idade < 21) {
                // Jovem
                img.setAttribute('src', 'components/imagens/mulherj.png')
            } else if (idade < 50) {
                // Adulto
                img.setAttribute('src', 'components/imagens/mulher.png')
            } else {
                // Velho
                img.setAttribute('src', 'components/imagens/velha.png')
            }
        }
